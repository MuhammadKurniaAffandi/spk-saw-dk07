...
<body>
    <div>
        ...
        <div style="margin-top: 25px; margin-bottom: 25px;">
            <center><strong><u>SURAT REKOMENDASI PEMILIHAN GURU TERBAIK</u></strong></center>
        </div>

        <p style="text-indent: 45px;">Berdasarkan hasil analisa data yang telah dilakukan pada periode
            {{ $laporan['periode'] }}, berikut ini kami
            rekomendasikan nama-nama guru sebagai kandidat yang dapat dipilih sebagai guru terbaik:</p>
                        ...
                        <tbody>
                            ...
                            @foreach ($sortedData as $key => $value)
                                <tr>
                                    ...
                                    <td class="no_urut ">{{ round($value, 2) }}</td>
        ...
        <p style="text-indent: 45px;">Demikian informasi ini kami sampaikan, agar dapat digunakan sebagaimana mestinya.
        </p>
