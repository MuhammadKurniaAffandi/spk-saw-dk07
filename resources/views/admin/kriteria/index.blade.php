    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#menu1">Tambah Kriteria</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#menu2">Tabel Kriteria</a>
                </li>
            </ul>
                                        ...
                                        <form action="{{ route('kriteria.store') }}" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="nama_kriteria" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="attribut" id="attribut"
                                                    ...
                                                    <option value="Benefit"
                                                        {{ old('attribut') == 'Benefit' ? 'selected' : '' }}>
                                                        Benefit
                                                    </option>
                                                    <option value="Cost"
                                                        {{ old('attribut') == 'Cost' ? 'selected' : '' }}>Cost
                                                    </option>
                                                </select>
